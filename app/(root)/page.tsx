...
export default async function Home() {
  ...
  <span className="text-blue-400   pl-2 pr-2"> Conferences</span>  
      on our platform
          ...
          Let's make every heartbeat count, every laugh echo, and every moment unforgettable. Begin your journey with WhipEvents today❗️ {emojis}
          </p>
          <Button size="lg" asChild className="shadow-md mt-4 w-full button sm:w-fit">
        <Link href="#events">
        Explore Events
        </Link>
        </Button>
       ...
       <div className="relative  w-[300px] h-[27rem] ml-auto mr-[3rem] md:mr-[4rem]">
        ...
        {/* </div> */}
        //
        <Image  src='/whitePattern.svg' alt="white pattern  for header section" height={55} width={55} className="absolute bottom-[15%] md:left-[18%] left-[3%]"/>
        ...
        <div className="flex-center flex-col">
          <p className="p-regular-16 text-darkenedGray-50">
            scroll to explore
          </p>
