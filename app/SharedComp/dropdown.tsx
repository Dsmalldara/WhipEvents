...
import { createCategory,getAllCategories } from "@/app/api/category.actions"

type DropdownProps = {
  value?: string
  onChangeHandler?: () => void // for the dropdown, it is called when the value of the dropdown changes
}
