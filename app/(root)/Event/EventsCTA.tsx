...
function EventsCTA() {
  return (
    <section className="wrapper md:py-10 py-5   bg-primary-50">
           <div className="grid px-4 md:px-10  md:gap-12 gap-8 md:grid-cols-2 grid-rows-[auto_auto]">
            <div>
                <img src="/createevent.png" className="h-[30rem] w-[33rem] md:w-[30rem]" alt="get tickets on whipevents"/>
            </div>
            <div className='md-[w-80%]'>
                <h3 className="md:text-[1.5rem]  text-[1rem] capitalize text-balance font-semibold text-amber-950 text-center antialiased">
                NO HIDDEN FEES OR SETUP CHARGES
                    </h3>
                <h1 className="md:p-bold-20 mt-6 font-bold md:font-normal text-balance text-center antialiased">
                ...
                <p className='md:pt-7 pt-3 text-xl font-bold md:text-start text-center'>
                    Create your event
                </p>
            </div>
           </div>
