...
function EventsCTA() {
  return (
    <section className="wrapper py-10   bg-primary-50">
           <div className="grid px-10  md:gap-12 gap-8 md:grid-cols-2 grid-rows-[auto_auto]">
            <div>
                <img src="/createevent.png" className="h-[30rem] w-[30rem]" alt="get tickets on whipevents"/>
            </div>
            <div className='md-[w-80%]'>
                <h3 className="md:text-[1.5rem]  text-[1rem] capitalize  font-semibold text-amber-950">
                NO HIDDEN FEES OR SETUP CHARGES
                    </h3>
                <h1 className="h2-medium mt-6 ">
